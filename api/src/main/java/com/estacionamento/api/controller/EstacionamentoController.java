...
public class EstacionamentoController {
    ...
    @Transactional
    public ResponseEntity adicionarVaga(@PathVariable Long id, @RequestBody @Valid VagaDto vagaDto) {
        var estacionamento = estacionamentoService.adicionarVaga(id, vagaDto);
