...
public class GlobalExceptionHandler {
    ...
    // Exception para quando o tipo de veiculo não é compativel com a vaga
    @ExceptionHandler(VagaNaoCompativelComVeiculoException.class)
    public ResponseEntity<?> handleVagaNaoCompativelComVeiculoException(VagaNaoCompativelComVeiculoException ex) {
        return buildErrorResponse(HttpStatus.CONFLICT, ex.getMessage());
    }
    ...
    // Exception para quando o horario não está cadastrado
    @ExceptionHandler(HorarioNaoCadastradoException.class)
    public ResponseEntity<?> handleHorarioNaoCadastradoException(HorarioNaoCadastradoException ex) {
